<?php
   ...
   echo "<html>\n";
   echo "   <head>\n";
   echo "      <title>ADTRAN System Fulfillment</title>\n";
   echo "      <h1 align='center'>ADTRAN Fulfillment Management</h1>";
   echo "   </head>\n";
  
   echo "   <body>\n";

   echo "   <style type=\"text/css\">\n";
   echo "      body {background:#ccffcc;}";
   ...
   $taskTable->setHeaderContents(0,0,"<a href=\"index.php\">Packdata History</a>");
   $taskTable->setHeaderContents(0,1,"<a href=\"index.php\">Incomplete Packdata Records</a>");
   $taskTable->setHeaderContents(0,2,"<a href=\"edit.php\">Edit Rec</a>");      
